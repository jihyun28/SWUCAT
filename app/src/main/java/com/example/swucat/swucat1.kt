...
class swucat1 : AppCompatActivity() {

    lateinit var homeBtn: Button
    lateinit var albumBtn: Button

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_swucat1)

        title = "<랑이를 소개합니다>"

        homeBtn = findViewById(R.id.homeBtn)
        albumBtn = findViewById(R.id.cat1Album)
        ...
        albumBtn.setOnClickListener {
            var intent = Intent(this, cat1Album::class.java)
            startActivity(intent)
        }
    }

    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        menuInflater.inflate(R.menu.menu_swucat1, menu)
        return true
    }
